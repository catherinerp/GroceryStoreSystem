...
Created: 02/04/2023
This page contains sql request for MEAT category.
-->
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body>
        <h1 style='text-align:center'>Browse Seafood</h1>
        <div class="main-content">
        <?php
            include "../../dbConfig.php";
            $query_string = "SELECT * FROM `products` WHERE product_id REGEXP '^2' AND (product_name LIKE '%oysters' OR product_name LIKE '%prawns');";
