...
<html lang="en">
	...
	<body>
        <h1 style='text-align:center'>Browse Vegetables</h1>
        <div class="main-content">
        <?php
            include "../../dbConfig.php";
            $query_string = "SELECT * FROM `products` WHERE product_id REGEXP '^1' AND product_name='vegetable'; ";
            $result = mysqli_query($conn, $query_string);
                ...
                if ($num_rows > 0) {
                    ...
                    echo "<h2 style='text-align:center'>Sorry! It seems we don't have any Vegetables. :(</h2>";
                }
                mysqli_close($conn);
            ?>
            <script>
