...
Created: 02/04/2023
This page contains sql request for pet food category.
-->
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body>
        <h1 style='text-align:center'>Browse Pet Food</h1>
        <div class="main-content">
        <?php
            include "../../dbConfig.php";
            $query_string = "SELECT * FROM `products` WHERE product_id REGEXP '^6' AND (product_name LIKE '%food' OR product_name LIKE '%treat');";
