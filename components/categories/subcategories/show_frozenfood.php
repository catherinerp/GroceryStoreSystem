...
Created: 02/04/2023
This page contains sql request for frozen food category.
-->
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body>
        <h1 style='text-align:center'>Browse Frozen Food</h1>
        <div class="main-content">
        <?php
            include "../../dbConfig.php";
            $query_string = "SELECT * FROM `products` WHERE product_id REGEXP '^4' AND (product_name LIKE '%fingers' OR product_name LIKE '%fries' OR product_name LIKE '%pizza');";
