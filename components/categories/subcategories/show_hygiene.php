...
Created: 02/04/2023
This page contains sql request for hygiene category.
-->
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body>
        <h1 style='text-align:center'>Browse Hygiene</h1>
        <div class="main-content">
        <?php
            include "../../dbConfig.php";
            $query_string = "SELECT * FROM `products` WHERE product_id REGEXP '^5' AND (product_name LIKE '%puff' OR product_name LIKE '%shampoo' OR product_name LIKE '%conditioner' OR product_name LIKE '%soap');";
