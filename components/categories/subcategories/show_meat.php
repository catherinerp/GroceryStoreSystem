...
<html lang="en">
	...
	<body>
        <h1 style='text-align:center'>Browse Meat</h1>
        <div class="main-content">
        <?php
            include "../../dbConfig.php";
            $query_string = "SELECT * FROM `products` WHERE product_id REGEXP '^2' AND (product_name LIKE '%patties' OR product_name LIKE '%steak');";
